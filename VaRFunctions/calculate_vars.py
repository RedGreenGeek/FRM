...
def calculate_vars_fx_converted(df_data, investments, alpha, market_dict):#), forex, alpha_fx, percentiles, n=200):
    ...
    mba_simple_var = MBA_simple(stock_returns, alpha, percentile=0.99, n=250)
    mba_ewma_var = MBA_EWMA(stock_returns.iloc[-250:, :], alpha, percentile=0.99, n=250, lam=0.95, sigma_init=None)
